	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    try {
	        ...
	        if (teacherIdParam == null || teacherIdParam.isEmpty()) {
	            ...
	            finalObject.put("error", "Missing teacherId parameter");
	        ...
	        while (rs.next()) {
	            ...
	            classes.put("class_name", rs.getString("class_name"));
	            classes.put("section", rs.getString("section"));
	            classes.put("room_number", rs.getString("room_number"));
	        ...
	        try {
	            finalObject.put("error", e.getMessage());
	            response.getWriter().write(finalObject.toString());
	        } catch (Exception ex) {
	            ex.printStackTrace();
	        }
